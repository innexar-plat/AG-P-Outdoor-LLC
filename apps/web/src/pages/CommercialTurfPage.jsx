  ...
  return (
    <>
      ...
      <PageHero
        ...
        fallbackUrl="https://images.unsplash.com/photo-1593177326901-7b65560a0c9b"
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg text-gray-700 space-y-4">
            <h2 className="text-3xl font-bold text-[#2c3e50]">Smart Investment for Commercial Properties</h2>
