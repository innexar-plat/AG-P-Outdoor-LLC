    ...
    <>
      <header
        className={`font-header fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          isScrolled
            ? 'bg-white/95 backdrop-blur-xl border-b border-emerald-100/80 shadow-lg py-2'
            : 'bg-gradient-to-r from-white/88 via-emerald-50/82 to-stone-50/88 backdrop-blur-xl border-b border-white/50 py-3'
        }`}
      >
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            <motion.div
              ...
              className="lg:hidden mt-4 pb-4 border-t border-emerald-200/70"
            >
